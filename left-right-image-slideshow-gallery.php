...
function Lrisg() 
{
	...
	?>
    <script type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-content/plugins/left-right-image-slideshow-gallery/inc/jquery.min.js"></script>
    <script type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-content/plugins/left-right-image-slideshow-gallery/inc/left-right-image-slideshow-gallery.js"></script>
...
function Lrisg_admin_options() 
{
	...
	echo "<div class='wrap'>";
	echo "<h2>"; 
	echo wp_specialchars( "Left right image slideshow gallery" ) ;
	echo "</h2>";
	$Lrisg_title = get_option('Lrisg_title');
	$Lrisg_width = get_option('Lrisg_width');
	$Lrisg_height = get_option('Lrisg_height');
...
function Lrisg_Show_Filter_Callback($matches) 
{
    ...
    $Lr = $Lr .'<script type="text/javascript" src="'.$Lrisg_pluginurl.'/inc/jquery.min.js"></script>';
    $Lr = $Lr .'<script type="text/javascript" src="'.$Lrisg_pluginurl.'/inc/left-right-image-slideshow-gallery.js"></script>';
...
function Lrisg_init()
{
	...
	{
		register_sidebar_widget('Left right image slideshow gallery', 'Lrisg_widget');
	}
	
	if(function_exists('register_widget_control')) 
	{
		register_widget_control(array('Left right image slideshow gallery', 'widgets'), 'Lrisg_control');
	} 
}
